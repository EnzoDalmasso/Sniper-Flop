...
{
public:
	nivel2(b2World* mundo);//El constructor recibe un mundo
...
private:
	...
	//Piso sujeta caja
	b2Body* bdy_sujetacaja;
	b2BodyDef bdydef_sujetacaja;
	b2Fixture* fix_sujetacaja;
	b2FixtureDef fixdef_sujetacaja;
